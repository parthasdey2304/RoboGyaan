    ...
    <>
      ...
      >
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <button
            className="md:hidden flex items-center justify-center p-2 rounded-xl text-slate-300 hover:text-neon-300 transition-colors"
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="relative h-full flex flex-col mobile-menu-enter">
                ...
                <ul className="space-y-6">
                  {NAV.map((item) => (
                    <li key={item.href}>
                      <a
                        ...
                        className="block text-center text-2xl font-bold text-white hover:text-neon-300 transition-colors py-2"
                      >
                        {item.label}
                      </a>
                    </li>
                  ...
                  <li>
                    <a
                      href="#contact"
                      onClick={handleLinkClick}
                      className="block w-full text-center rounded-full bg-zap-400 px-8 py-4 text-lg font-bold text-ink shadow-[0_0_24px_rgba(250,204,21,0.5)] transition hover:bg-zap-500 hover:shadow-[0_0_36px_rgba(250,204,21,0.7)]"
                    >
                      Book a Demo
                    </a>
                  </li>
            ...
            <div className="pb-12 text-center text-sm text-slate-500">
